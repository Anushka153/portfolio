...
<Image src={Shein} alt="Shein" className="mx-auto rounded-lg w-[700px] h-[350px]" />
    <div className="relative pt-12 pb-12 px-8 sm:px-16 max-w-full mx-auto">
      {sections.map((section, index) => (
        ...
        >
          <h2 className="section-title text-3xl font-bold text-[#b16925] mb-4">{section.title}</h2>

          {!!section.isImage ? (
            <div className="flex flex-wrap">
              <div className="w-full md:w-1/2 p-4">
                <Image src={section.isImage} alt="Shein" className="rounded-lg" />
              </div>
              <div className="w-full md:w-1/2 p-4">
